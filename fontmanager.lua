...
function BitmapString:setText(newText)
	...
	if hasDecimal then
		temp2 = string.sub(temp, decPlace)
	end

	if hasDecimal then
		if string.sub(temp, length - 1, length) == ".0" then
			oneZero = true
		else
			for i = 1, string.len(temp2) - 1, 1 do
				if string.sub(temp2, i + 1, i + 1) == "0" then
					decZero = decZero + 1
				else
					decZero = 0
					print("it broke")
	...
	if string.sub(temp, string.len(temp)) == "." then
	--do nothing
		...
		if temp then newText = tostring(temp)
			...
			elseif decZero > 0 then
				for i = 1, decZero, 1 do
					if i == 1 then newText = newText .. ".0"
					else newText = newText .. "0" end
				end
			else
				for i = 1, zeroCount, 1 do
					newText = newText .. "0"
				end
			end
		end
